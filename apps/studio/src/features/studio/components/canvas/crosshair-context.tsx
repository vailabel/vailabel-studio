...
export const Crosshair: React.FC<CrosshairProps> = memo(({ canvasRef, baseOffset }) => {
  ...
  return (
    <div data-testid="crosshair">
      <div
        className="absolute border-l border-ring border-dashed pointer-events-none z-10"
        style={styles.vertical}
      />
      <div
        className="absolute border-t border-ring border-dashed pointer-events-none z-10"
