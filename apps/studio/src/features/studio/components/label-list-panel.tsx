import { cn, getContentBoxColor } from "@/shared/lib/utils"
    ...
    return (
      ...
      >
        <span
          ...
          className={cn(
            "h-4 w-4 flex-shrink-0 rounded-full border-2 border-background shadow-sm",
            label.isAIGenerated && "ring-2 ring-success"
          )}
        />
        ...
        {label.isAIGenerated && (
          <Badge
            variant="outline"
            className="flex-shrink-0 gap-1 border-success/30 bg-success/10 text-success"
          >
