...
import type { LabelCreateForm } from "@/features/projects/model/project-detail-viewmodel"
import { LabelCreateSchema } from "@/features/projects/model/project-detail-viewmodel"
import { randomLabelColor } from "@/shared/lib/label-colors"
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            ...
            />
            {errors.name && (
              <p className="text-destructive text-xs flex items-center gap-1 animate-in fade-in slide-in-from-top-1 duration-200">
                <span>⚠</span>
                {errors.name.message}
              </p>
            )}
            ...
            <div className="flex gap-2 items-center">
              ...
              <div className="flex gap-1 items-center">
                {colorPalette.map((color) => (
                  ...
                  >
                    {labelColor === color && (
                      <span className="block w-3 h-3 rounded-full border-2 border-background bg-card/30" />
                    )}
                  </button>
                ))}
