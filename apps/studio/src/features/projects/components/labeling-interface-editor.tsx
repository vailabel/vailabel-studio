...
import { CONFIG_PRESETS } from "@/shared/lib/label-config/presets"
import { serializeConfig } from "@/shared/lib/label-config/generate"
...
const JsonConfigEditor = lazy(
  () => import("@/features/projects/components/json-config-editor")
)
