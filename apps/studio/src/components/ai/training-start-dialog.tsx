...
import { useStartTraining } from "@/viewmodels/ai-runtime-viewmodel"
import type { Project } from "@/types/core"
import type { DatasetExportResult } from "@/types/ai-runtime"
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        {result ? (
          ...
          <div className="space-y-4">
            ...
            <p className="rounded-md border border-amber-500/20 bg-amber-500/10 p-2.5 text-xs text-muted-foreground">
