...
import { keyframeFrames } from "@/lib/video/track-engine"
import type { Track, VideoMeta } from "@/types/video"
    ...
    <div className="rounded-lg border border-border bg-card p-3 space-y-2">
      ...
      >
        ...
        {meta.sceneCuts.map((cut) => (
          ...
          >
            <Scissors className="h-3 w-3 text-amber-400 -translate-x-1/2 absolute -top-0.5" />
          </div>
        ))}
