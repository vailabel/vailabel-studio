...
export const FreeDrawAnnotation = memo(({ annotation }: FreeDrawAnnotationProps) => {
  ...
  const boundingBoxElement = useMemo(() => {
    ...
    return (
      <rect
        ...
        stroke={isSelected ? "rgba(59, 130, 246, 0.7)" : "rgba(59, 130, 246, 0.3)"}
  ...
  const handleCenterPointMouseDown = useCallback((e: React.MouseEvent<SVGCircleElement>) => {
    e.stopPropagation()
