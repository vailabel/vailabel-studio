    ...
    <div className={cn("flex items-center justify-center gap-4 md:gap-8 py-8 px-4", className)}>
      {steps.map((step, idx) => (
        <div key={step.label} className="flex items-center gap-2 md:gap-4">
          ...
          {idx < steps.length - 1 && (
            <div
              className="hidden md:block w-12 h-0.5 bg-gradient-to-r from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-700 mx-2 relative overflow-hidden origin-left transition-transform duration-300"
              style={{
