...
export const LABELING_TEMPLATES: LabelingTemplate[] = [
  ...
  // ── Generative AI / LLM ──────────────────────────────────────────────────
  // Multi-field tasks imported from a spreadsheet (one row per task; columns map
  // to the config's field names). Rendered by the config-driven editor.
  {
    id: "rlhf",
    label: "Human Preference (RLHF)",
    description: "Pick the better of two responses (columns: prompt, response_a, response_b)",
  ...
  },
  {
    ...
    description: "Compare two model outputs and flag overall quality",
    category: "Generative AI / LLM",
    dataKind: "multimodal",
    icon: Scale,
    modality: "custom",
  ...
  },
  {
    ...
    description: "Rate and label a single model response (columns: prompt, response)",
    category: "Generative AI / LLM",
    dataKind: "multimodal",
    icon: Sparkles,
    modality: "custom",
  ...
  },
  {
    ...
    description: "Rate retrieval-augmented answers for faithfulness & grounding",
    category: "Generative AI / LLM",
    dataKind: "multimodal",
    icon: Sparkles,
    modality: "custom",
  ...
  },
  {
    ...
    description: "Flag unsupported claims in a model response",
    category: "Generative AI / LLM",
    dataKind: "multimodal",
    icon: Search,
    modality: "custom",
  ...
  {
    id: "safety-rating",
    label: "Safety & Toxicity Rating",
    description: "Categorize and rate the severity of unsafe responses",
    category: "Generative AI / LLM",
    dataKind: "multimodal",
    icon: ShieldAlert,
    modality: "custom",
  ...
  {
    id: "function-calling-eval",
    label: "Function / Tool-Call Evaluation",
    description: "Judge tool selection and arguments for agent calls",
    category: "Generative AI / LLM",
    dataKind: "multimodal",
    icon: Code2,
    modality: "custom",
  ...
  },
  {
    ...
    description: "Rate a whole assistant conversation (import .txt transcripts)",
    category: "Generative AI / LLM",
    dataKind: "text",
    icon: MessagesSquare,
    modality: "custom",
