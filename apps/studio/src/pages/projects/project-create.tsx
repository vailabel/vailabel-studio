...
export function ProjectCreate() {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 mt-8">
      {/* Stepper UI */}
                  ...
                  >
                    <PopoverTrigger asChild>
                      <Button
                        ...
                        className="w-8 h-8 p-0 border border-gray-300 shadow-sm hover:scale-105 transition-transform"
