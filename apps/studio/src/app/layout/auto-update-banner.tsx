...
export const AutoUpdateBanner = () => {
  ...
  // Nothing to show, or the user chose "Later" for this session.
    ...
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-full max-w-md z-50 animate-in slide-in-from-bottom-4 duration-300">
      <Card className="border-primary/20 bg-card shadow-lg">
        <CardContent className="p-4 space-y-4">
          {/* Available — awaiting user action */}
          {updateAvailable && !progress && !updateDownloaded && (
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Version {updateAvailable.version ?? "new version"} is ready
                    to install
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                <Button onClick={installUpdate} className="flex-1" size="sm">
          ...
          {updateDownloaded && !progress && (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={relaunchApp} className="flex-1" size="sm">
