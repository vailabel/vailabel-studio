...
pub const REGISTRY: &[RegistryModel] = &[
    ...
    RegistryModel {
        ...
        description: "Open-vocabulary YOLO: detect arbitrary classes from text prompts via CLIP text embeddings. Reuses the existing detection decode path.",
        params: "~50M+",
        onnx_components: &["yolo_world.onnx"],
        needs_tokenizer: true,
        source: "Ultralytics YOLO-World export",
        status: "planned",
    },
    RegistryModel {
        id: "clip",
