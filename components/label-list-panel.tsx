  ...
  return (
    ...
    >
      <div className={cn("p-4 border-b", darkMode ? "border-gray-700" : "border-gray-200")}>
        ...
        <p className={cn("text-sm", darkMode ? "text-gray-400" : "text-gray-500")}>{labels.length} total</p>
      </div>
            ...
            <CollapsibleContent>
              {Object.entries(labelsByCategory).map(([category, categoryLabels]) => (
                <div key={category} className="mt-4">
                  <h3 className={cn("mb-2 text-xs font-medium", darkMode ? "text-gray-400" : "text-gray-500")}>
                    {category}
                  </h3>
                  <div className="space-y-1">
                    {categoryLabels.map((label) => (
                      ...
                      >
                          ...
                          <div className="flex items-center">
                            <div
                              className={cn(
                                ...
                                label.isAIGenerated ? "bg-green-500" : `bg-${label.color || "blue-500"}`,
                              )}
                            />
                        ...
                        <p className={cn("mt-1 text-xs truncate", darkMode ? "text-gray-400" : "text-gray-500")}>
                          {label.isAIGenerated && "🤖 "}
              ...
              {labels.length === 0 && (
                ...
                >
                  <p className={cn("text-sm", darkMode ? "text-gray-400" : "text-gray-500")}>No labels created yet</p>
