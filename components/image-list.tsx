...
export function ImageList({ project, currentImageIndex, onImageSelect }: ImageListProps) {
  ...
  return (
    ...
    >
      <div className={cn("p-4 border-b", darkMode ? "border-gray-700" : "border-gray-200")}>
        ...
        <p className={cn("text-sm", darkMode ? "text-gray-400" : "text-gray-500")}>{project.images.length} total</p>
      </div>
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      currentImageIndex === index &&
                        (darkMode ? "bg-blue-900 text-blue-300" : "bg-blue-50 text-blue-500"),
                    )}
